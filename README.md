...
var nhat = new Developer
{
    ...
    Ask        = "ASP.NET Core · CQRS · Clean Architecture · ERP Systems",
    Contact    = "https://minhnhatluong.win-tech.vn"
};
```
...
![Repository Pattern](https://img.shields.io/badge/Repository_Pattern-0e75b6?style=flat-square)
![MediatR](https://img.shields.io/badge/MediatR-0e75b6?style=flat-square)
